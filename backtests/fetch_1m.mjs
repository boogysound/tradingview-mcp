...
async function main() {
  ...
  writeFileSync('/Users/boogy/tradingview-mcp/backtests/data_1m.json', JSON.stringify(bars));
  console.error(`  saved ${bars.length} bars -> data_1m.json (${new Date(bars[0].time * 1000).toISOString()} .. ${new Date(bars[bars.length - 1].time * 1000).toISOString()})`);
